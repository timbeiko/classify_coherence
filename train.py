...
tf.flags.DEFINE_string("incoherent_data_file", "./data/random/incoherent_sentences_arg2_diff_sense_gamma_0.4.txt", "Data source for the incoherent data.")
...
# Load data
coherent_sentences = list(open(FLAGS.coherent_data_file, 'r').readlines())
coherent_sentences = [c.strip() for c in coherent_sentences]
incoherent_sentences = list(open(FLAGS.incoherent_data_file, 'r').readlines())
